        ...
        <form action="{{route('admin.blog.store')}}" method="post" enctype="multipart/form-data" id="formBlog">
            ...
            <div class="container">
                ...
                <div class="ibox">
                    <div class="ibox-content">
                        <div>
                            <textarea rows="50" name="details"  class="desc form-control  @error('details') is-invalid @enderror" value="" placeholder="Describe yourself here...">{{ old('details') }}</textarea>
                       ...
                       <div class="row">
                            <div class="col-lg-6">
                                 ...
                                 <label for="author_name"><b>Author Name</b></label>
                                     <input type="text" class="form-control  @error('title') is-invalid @enderror" name="author_name" value="{{ old('author_name') }}" value="{{ old('author_name') }}" placeholder="enter author name...">
                                     @error('author_name')
                                     <small class="text-danger">{{ $message }}</small>
                                     @enderror
                                 </div>
