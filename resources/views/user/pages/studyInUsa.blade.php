...
@section('content')
  ...
  <!-- USA first section end -->

  <!-- USA second section start -->
                  ...
                  <div class="col-sm-12 mx-auto col-lg-6 col-lg-6">
                      <div class="video-box">
                          <figure class="figure1 mb-0">
                            ...
                            <img src="{{asset('assets/images/destination/usa/usa-bot.jpg')}}" alt="Image">
