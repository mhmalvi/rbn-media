          ...
          <div class="row align-items-center large-gap wow fadeInLeft delay-0-2s pt-20">
              <div class="col-lg-8 mx-auto">
                  <ul class="why-learn-content rmb-35">
                     ...
                     <p>Our talented content developer team writes the proper, meaningful, and comprehensive statement of purpose (SOP). We give this support if any student fails to demonstrate his or her own study plan. It matters! Because your perspective on life, career goals, ideology, program, subject selection, and financial statement all are evaluated by the admission committee when you have a perfect SOP.</p>
                     </li>
                     ...
                     <p>The cross-check phase includes making sure that all required documents are attached and all entry requirements have been met. If we find anything missing or incorrect, we resolve this before submitting the final application form.</p>
                     </li>
                  </ul>
              </div>
          </div>
