...
@section('content')
          ...
          <li>
                  <div class="flip-box  mx-auto">
                    <div class="flip-box-inner">
                        ...
                        <img src="{{asset('assets/images/destination/malay/topcities/111.png')}}"  class="" alt="" style="width: 50%; align-items: center">
                        </div>
              ...
              <li>
                  <div class="flip-box  mx-auto">
                    <div class="flip-box-inner">
                        <div class="flip-box-front">
                        <img src="{{asset('assets/images/destination/malay/topcities/444.png')}}"  class="" alt="" style="width: 50%; align-items: center">
                        </div>
                        <div class="flip-box-back">
                        <h4>SELANGOR</h4>
                        </div>
              ...
              <li>
                  <div class="flip-box  mx-auto">
                    <div class="flip-box-inner">
                        <div class="flip-box-front">
                        <img src="{{asset('assets/images/destination/malay/topcities/555.png')}}"  class="" alt="" style="width: 50%; align-items: center">
                        </div>
                        <div class="flip-box-back">
                        <h4>MALACCA</h4>
                        </div>
                ...
                <div class="col-sm-12 mx-auto col-lg-6 pt-md-2 m-auto">
                    <div class="video-box" style="padding: 19%;">
                        ...
                        <figure class="figure circle-styled">
                            <img class="img-fluid" src="{{asset('assets/images/destination/malay/mal-top.jpg')}}" alt="Image">
                        </figure>
                    </div>
                </div>
  ...
  <!--Malaysia first section end -->

  <!-- Malaysia second section start -->
                  ...
                  <div class="col-sm-12 mx-auto col-lg-6 col-lg-6">
                      <div class="video-box">
                          <figure class="figure1 mb-0">
                            {{-- <img width="75%" src="{{asset('assets/images/destination/uk/mal-bot.jpg')}}" alt="Image"> --}}
                            <img src="{{asset('assets/images/destination/malay/mal-bot.jpeg')}}" alt="Image">
