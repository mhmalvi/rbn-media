                        ...
                        <div class="col-lg-8">
                            <div class="blog-details-wrap">
                                <div class="blog-standard-item wow fadeInUp delay-0-2s">
                                    <div class="image">
                                        <img src="{{ asset('assets/admin/image/articles/'.$article->thumbnail) }}" alt="Article Thumbnail">
                                        ...
                                        <div class="content">
                                            <div class="mb-50">
                                                ...
                                                <ul class="blog-standard-header">
                                                    ...
                                                    <li><i class="far fa-calendar-alt"></i> <a href="javascript:void(0)" class="text-secondary">{{ date('M d, Y', strtotime($article->created_at)) }}</a></li>
                            ...
                            <div class="blog-sidebar rmt-75">
                                ...
                                <div class="widget widget-recent-courses wow fadeInUp delay-0-2s">
                                    <h4 class="widget-title">Recent Articles</h4>
                                        ...
                                        @isset($recent_articles)
                                            @foreach($recent_articles as $article)
                                                <div class="container mb-20">
                                                <div class="row">
                                                    <div class="image col-12 mb-15">
                                                        <img src="{{ asset('assets/admin/image/articles/'.$article->thumbnail) }}" alt="Article thumbnail" class="img-thumbnail">
                                                    </div>
                                                </div>
                                                <div class="row">
