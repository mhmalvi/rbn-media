              ...
              <div class="col-lg-8 mx-auto">
                  <ul class="why-learn-content rmb-35">
                     <li class="visaService-li">
                           ...
                           <p>Provide a checklist for proper visa documentation</p>
                      </li>

                     <li class="visaService-li">
                           <img src="assets/images/service/tick.png" class="visaService-bullet" alt="">
                           <p>Additional support in paperwork if required</p>
                     </li>

                     <li class="visaService-li">
                           <img src="assets/images/service/tick.png" class="visaService-bullet" alt="">
                           <p>Organize the documents according to immigration regulations and standards</p>
                     </li>

                     <li class="visaService-li">
                           <img src="assets/images/service/tick.png" class="visaService-bullet" alt="">
                           <p>Educational credential assessment (ECA) & notarization of academic documents if required</p>
                     </li>

                     <li class="visaService-li">
                           <img src="assets/images/service/tick.png" class="visaService-bullet" alt="">
                           <p>Fill up the visa application form accurately</p>
                     </li>

                     <li class="visaService-li">
                           <img src="assets/images/service/tick.png" class="visaService-bullet" alt="">
                           <p>Take a number of classes and demo interviews before the final visa interview</p>
                     </li>

                     <li class="visaService-li">
                           <img src="assets/images/service/tick.png" class="visaService-bullet" alt="">
                           <p>Conclude the entire visa application procedure meticulously</p>
                     </li>
                  </ul>
              </div>
          </div>
