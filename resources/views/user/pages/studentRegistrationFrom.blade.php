...
<div class="container mb-100 mt-100 d-block">
    <div>
        <form class="form ajax-form" method="POST" action="{{ url('student-registration') }}">
        @csrf
            <div class="row">
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="selectbox">
                                        <select id="nationality" name="country" class="form-control rounded-pill">
                                            <option disabled="true" selected="true" value="---">Select Nationality</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="selectbox">
                                        <select name="mobile_code" id="mobile_code" class="form-control rounded-pill" required="">
                                            <option disabled="true" selected="true" value="">Select Country Code..</option>
...
>>>>>>> c618dc860dbb51d4c8e2d37d5ffea61f138a7cd8
                        ...
                        <div class="checkbox-detailed">
                          <input type="radio" name="study_gap" id="check-det-1" value="Male" required="">
                          <label for="check-det-1">
                            <span class="checkbox-detailed-tbl">
                              <span class="checkbox-detailed-cell">
                                <span class="checkbox-detailed-title">Yes</span>
                        ...
                        <div class="checkbox-detailed">
                          <input type="radio" name="study_gap" id="check-det-2" value="Female" required="">
                          <label for="check-det-2">
                            <span class="checkbox-detailed-tbl">
                              <span class="checkbox-detailed-cell">
                                <span class="checkbox-detailed-title">No</span>
...
>>>>>>> c618dc860dbb51d4c8e2d37d5ffea61f138a7cd8
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="checkbox-detailed">
                                        <input type="radio" name="language_certificate" id="check-certificate-1" value="yes" required="">
                                        <label for="check-certificate-1">
                                            <span class="checkbox-detailed-tbl">
                                                <span class="checkbox-detailed-cell">
                                                    <span class="checkbox-detailed-title">Yes</span>
                                    ...
                                    <div class="checkbox-detailed ml-3">
                                        <input type="radio" name="language_certificate" id="check-certificate-2" value="no" required="">
                                        <label for="check-certificate-2">
                                            <span class="checkbox-detailed-tbl">
                                                <span class="checkbox-detailed-cell">
                                                    <span class="checkbox-detailed-title">No</span>
