              ...
              <div class="col-lg-2 col-md-3 col-sm-4">
                  <div class="footer-widget menu-widget">
                      ...
                      <ul>
                          ...
                          <li><a href="javascript:void(0)">study in dubai</a></li>
                          <li><a href="javascript:void(0)">study in germany</a></li>
                          <li><a href="javascript:void(0)">study in malaysia</a></li>
                      </ul>
                  </div>
              </div>
              <div class="col-lg-5">
                          ...
                          <div class="footer-widget contact-info-widget">
                              ...
                              <ul>
                                  ...
                                  <li>
                                      ...
                                      <a href="mailto:support@gmail.com">info@rbn.com.bd</a>
                                  </li>
                                  <li>
                                      <i class="fas fa-phone"></i>
                                      <a href="callto:+0123456789">+8801312777919</a>
                                  </li>
                                  <!--  <li>
